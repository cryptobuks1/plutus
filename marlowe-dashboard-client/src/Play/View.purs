...
renderPlayState :: forall p. WalletLibrary -> Nickname -> String -> RemoteData AjaxError PubKey -> Array Template -> State -> HTML p Action
...
------------------------------------------------------------
renderMain :: forall p. WalletLibrary -> Nickname -> String -> RemoteData AjaxError PubKey -> Array Template -> State -> HTML p Action
renderMain wallets newWalletNickname newWalletContractId remoteDataPubKey templates playState =
  let
...
renderCards :: forall p. WalletLibrary -> Nickname -> String -> RemoteData AjaxError PubKey -> Array Template -> WalletDetails -> Maybe Card -> Contract.State -> HTML p Action
renderCards wallets newWalletNickname newWalletContractId remoteDataPubKey templates walletDetails card contractState =
  div
